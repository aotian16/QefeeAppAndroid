...
public class AddVisibilityActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_visibility);
        setupActionBar();
        ...
        submitButton.setOnClickListener(v -> {
            ...
            bean.save(new SaveListener<String>() {
                ...
                public void done(String s, BmobException e) {
                    if (e == null) {
                        i("add VisibilityBean success. objectId = " + s);
                        showToast("add success");
                    } else {
                        e("add VisibilityBean fail.", e);
